...
/**
 * Server Component - Displays the approximate capital required to purchase a Canadian Gold Maple Leaf.
 * 
 * Uses product pricing from Monex API via SITE_CONFIG.productSymbol.
  ...
  return (
    <div className="card p-8 max-w-sm">
      ...
      <p className="text-gray-400 text-sm text-center mb-6">
        {hasValidPrice
          ? `Based on current Gold Maple Leaf (${SITE_CONFIG.productSymbol}) ask price:`
          : "To purchase a single Canadian Gold Maple Leaf:"}
      </p>
      <div className="text-center py-6 rounded-lg bg-bullion-gold/10 border border-bullion-gold/30">
        {hasValidPrice ? (
          <>
            ...
            <p className="text-gray-400 text-sm mt-2">per 1 oz Gold Maple Leaf</p>
          </>
        ) : (
          <>
